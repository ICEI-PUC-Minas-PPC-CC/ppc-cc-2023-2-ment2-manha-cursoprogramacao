...
|4| Modularização. Exemplificações ao passo que o conteúdo é ensinado. Sessão para desenvolver um projeto final prático (desenvolver o jogo da Forca e uma calculadora simples).    | 2 horas |
